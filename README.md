...
**Live app:** https://accounts.worksquares.ai · **API:** https://accounts-api.worksquares.ai · **Docs:** https://docs.worksquares.ai
...
**Do not report security vulnerabilities as public issues.** Use [private vulnerability reporting](https://github.com/worksquares/accounts-issues/security/advisories/new) instead — see [SECURITY.md](SECURITY.md).
